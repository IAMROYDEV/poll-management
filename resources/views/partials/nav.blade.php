                ...
                @role('admin')
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <a class="dropdown-item {{ (Request::is('roles') || Request::is('permissions')) ? 'active' : null }}" href="/polls">
                                {!! trans('titles.pollsManagement') !!}
                            </a>
                            <a class="dropdown-item {{ (Request::is('roles') || Request::is('permissions')) ? 'active' : null }}" href="/questions">
                                {!! trans('titles.questionsManagement') !!}
                            </a>
